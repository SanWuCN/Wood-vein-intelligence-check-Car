...
import {Map,Route as RouteIcon,Settings,Square,Save,RotateCcw,RotateCw,Magnet,CircleDot,Sparkles,Play,Pause,LocateFixed,Trash2,Camera,Radio,Wifi,WifiOff,X,Check,LoaderCircle,Plus,ArrowUp,ArrowDown,ArrowLeft,ArrowRight,Activity,Maximize2,Minimize2,Crosshair} from 'lucide-react';
