...
export function App(){
 ...
 {running&&<div className="mission-progress"><span>航点 {(s?.mission.index||0)+1} / {s?.mission.points.length}</span><span>{mode==='loop'?`第 ${(s?.mission.cycle||0)+1} 圈`:fmt(s?.mission.distance_remaining,1)+' m'}</span></div>}
 </div></Panel></>}
 </aside></main>
